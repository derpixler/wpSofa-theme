 ...
 */
function wpsofa_the_post_meta( $post_id = null, $location = 'single-top' ) {

	echo wpsofa_get_post_meta( $post_id, $location ); //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Escaped in twentytwenty_get_post_meta().
 ...
 */
function wpsofa_get_post_meta( $post_id = null, $location = 'single-top' ) {
